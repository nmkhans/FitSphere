      ...
      <div className="main-container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
            {action === "upgrade"
              ? "Choose a higher plan to unlock more features and benefits."
              : action === "downgrade"
              ? "Select a different plan that better fits your needs."
              ...
              {isTrainer && (
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 max-w-2xl">
                  <p className="text-amber-800 text-sm font-medium">
                    🏋️‍♂️ As a trainer, you have access to all gym
                    facilities and trainer features. Membership plans
                    are designed for gym members only.
                  </p>
                </div>
              )}
            </div>
